...
// Generated value is further divided by a shaping function as a way to ensure air / ground distinction

// TODO: Separate generation logic from worker logic (so that can be done sync or async)
// NOTE: unless generator is also included on the page it does not help caching issues 
...
onmessage = function(e) {
	...
	var kMin = e.data.kMin;
	var kMax = e.data.kMax;
	...
	// Generate Chunks
	var iteration = 0;
	var totalIterations = (iMax - iMin + 1) * (kMax - kMin + 1) * areaHeight;
	var chunkOffset = [];
